		...
		<div class="logo-color logo-color-light">
			<div class="logo">
				<div class="logo-middle">            
					<a href="#"><img src="{{asset('app-assets')}}/images/logo.svg" alt="Logo"></a>
				</div>
			</div>
		</div>
				...
				<ul>
					<li class="dropdown show setting">
						...
						<li class="dropdown show user-profile">
							...
							<div class="dropdown-menu dropdown-menu-right" style="position:absolute;transform:translate3d(-261px, 18px, 0px);will-change:transform">
									...
									<div class="row">
										...
										<div class="col-4">
											<div class="avatar mr-1">
												<img class="img-fluid" src="{{asset('app-assets')}}/images/team/03.jpg" alt="">
											</div>
										</div>
									</div>
								</div>
								<div class="profile-info">
									...
									<form action="{{route('logout')}}" method="post">
										<button class="btn btn-outline-primary outline-gray btn-sm mt-3"> <i class="la la-power-off"></i> Logout </button>
										@csrf
									</form>
								</div>
							</div>
