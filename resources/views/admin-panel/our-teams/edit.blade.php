            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="ourTeam" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6" >
                                <input type="hidden" name="our_team_id" value="{{$our_team->id}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="designation" placeholder="Designation" value="{{$our_team->designation}}">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <select name="category" id="" class="form-control">
                                    @forelse ($our_team_roles as $our_team_role)
                                        <option value="{{$our_team_role->id}}" {{$our_team->our_team_roles_id == $our_team_role->id ? 'selected' : '' }}>{{$our_team_role->role}}</option>
                                    @empty
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            ...
                            <button type="submit" id="submitourTeamBtn" class="btn btn-outline-primary">Update</button>
                        </div>
                    </form>
...
@section('custom-js')
    <script>
        ...
        FilePond.create(document.getElementById('image'), {
            ...
            @if (isset($our_team['image']))
                , files: [{
                        source: "{{ asset('storage/teams/' . $our_team->image) }}",
                    }],
            @endif
