        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-title">
                    ...
                    <a href="{{ route('report.create',['type'=>$type]) }}" class="btn btn-outline-primary"> <i class="feather icon-plus"></i> Add
                        new</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="report-table" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Organization</th>
                                    <th style="width: 20%">Report File</th>
                                    <th>Category</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
...
<script>
    var table = null;
        $(document).ready(function(){
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('webinar',['type'=>'reports']) }}",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
