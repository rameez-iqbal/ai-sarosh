        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-title">
                    ...
                    <a href="{{ route('video.create',['type'=>$type]) }}" class="btn btn-outline-primary"> <i class="feather icon-plus"></i> Add
                        new</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="video-table" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>image</th>
...
<script>
    var table = null;
        $(document).ready(function(){
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('webinar',['type'=>'videos']) }}",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
